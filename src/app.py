...
def update_drop_options(country):
    if country == 'mx':
        ...
        options2 = [
            {'label': 'ES 2022 Completo - Opción: AMCM, 25 CDS, GDL y MTY 20% UPMs',
             'value': 'option 1.csv'},
            {'label': 'ES 2022 Completo - Opción: AMCM, 25 CDS, GDL y MTY 25% UPMs',
             'value': 'option 2.csv'},
            {'label': 'ES 2022 Completo - Opción: AMCM, 25 CDS, GDL y MTY 50% UPMs',
             'value': 'option 3.csv'}
        ]
        value2 = 'option 1.csv'
        ...
        options3 = [
            {'label': 'ES 2022 Completo - Opción: AMCM, 25 CDS, GDL y MTY 20% UPMs',
             'value': 'tasas_option 1.csv'},
            {'label': 'ES 2022 Completo - Opción: AMCM, 25 CDS, GDL y MTY 25% UPMs',
             'value': 'tasas_option 2.csv'},
            {'label': 'ES 2022 Completo - Opción: AMCM, 25 CDS, GDL y MTY 50% UPMs',
             'value': 'tasas_option 3.csv'}
         ]
